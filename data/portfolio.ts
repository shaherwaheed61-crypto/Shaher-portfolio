...
export const projects: Project[] = [
  {
    ...
    gallery: [
      ...
      { src: "/images/gardens-project/shop-drawings/aviary-garden-plan.webp", alt: "Cropped public portfolio excerpt of the Aviary Garden landscape shop drawing plan", caption: "Aviary Garden — landscape shop drawing plan", group: "Selected shop drawing evidence" },
      { src: "/images/gardens-project/shop-drawings/butterfly-garden-plan.webp", alt: "Cropped public portfolio excerpt of the Butterfly Garden landscape shop drawing plan", caption: "Butterfly Garden — landscape shop drawing plan", group: "Selected shop drawing evidence" },
      { src: "/images/gardens-project/shop-drawings/carboniferous-garden-plan.webp", alt: "Cropped public portfolio excerpt of the Carboniferous Garden landscape shop drawing plan", caption: "Carboniferous Garden — landscape shop drawing plan", group: "Selected shop drawing evidence" },
      { src: "/images/gardens-project/shop-drawings/cretaceous-garden-plan.webp", alt: "Cropped public portfolio excerpt of the Cretaceous Garden landscape shop drawing plan", caption: "Cretaceous Garden — landscape shop drawing plan", group: "Selected shop drawing evidence" },
      { src: "/images/gardens-project/shop-drawings/devonian-garden-plan.webp", alt: "Cropped public portfolio excerpt of the Devonian Garden landscape shop drawing plan", caption: "Devonian Garden — landscape shop drawing plan", group: "Selected shop drawing evidence" },
      { src: "/images/gardens-project/shop-drawings/discovery-garden-plan.webp", alt: "Cropped public portfolio excerpt of the Discovery Garden landscape shop drawing plan", caption: "Discovery Garden — landscape shop drawing plan", group: "Selected shop drawing evidence" },
      { src: "/images/gardens-project/shop-drawings/discovery-garden-sections-details.webp", alt: "Cropped public portfolio excerpt of Discovery Garden landscape sections and construction details", caption: "Discovery Garden — sections and construction details", group: "Selected shop drawing evidence" },
    ],
  },
  {
