...
export default function ProfilePage() {
  return (
    <main>
      <section className="page-hero"><div className="shell profile-hero"><div><p className="mono-label">Profile / Riyadh</p><h1 className="page-title">Architecture grounded in technical delivery.</h1><p className="profile-summary">{portfolio.summary}</p><Link className="text-link" href="/contact">Contact Shaher <ArrowUpRight size={15} /></Link></div><div className="portrait-frame"><img src="/images/about/portrait-v2.jpg" alt="Shaher Waheed Roshdy" /></div></div></section>
